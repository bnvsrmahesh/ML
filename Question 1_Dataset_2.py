# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 13:55:11 2020
...
def bayesclassifier(X,mean0,mean1,mean2,cov0,cov1,cov2,L):
...
Data = pd.read_csv("Dataset_2_Team_30.csv")#read a csv file csv=comma seprated values
...
y1 = np.linspace(-150,125,num = 500)#test x1 points created
y2 = np.linspace(-175,175,num = 500)#test x2 points created
...
cset = ax.contour(X, Y, Z, zdir='z', offset=-3e-4)
